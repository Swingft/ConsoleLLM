...
Exclude 모드 전용 분석기
- 프로젝트의 모든 Swift 파일들을 분석
- 난독화에서 제외되어야 할 식별자들을 식별
"""
...
class ExcludeAnalyzer(BaseAnalyzer):
    ...
    def __init__(self, base_model_path: str, lora_path: str = None,
        ...
        # Exclude용 AST 분석기 경로
        self.ast_analyzer_path = "./SwiftASTAnalyzer_exclude/.build/release/SwiftASTAnalyzer"
    ...
    def generate_analysis(self, swift_file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = model.create_chat_completion(
                messages=messages,
                temperature=0.2,  # 안정적인 분석을 위한 낮은 temperature
                top_p=0.95,
                max_tokens=4096,
            )
